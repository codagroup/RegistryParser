...
internal class TestVkCellRecord
{
    ...
    public void ShouldFindRegBinaryValues()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(t => t.ValueName == "@themeui.dll,-850");
    ...
    public void ShouldFindRegDWordValues()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(t => t.ValueName == "DblDist");
    ...
    public void ShouldFindRegExpandSzValues()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(t => t.ValueName == "TEMP");
    ...
    public void ShouldFindRegMultiSzValues()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(t => t.ValueName == "Languages");
    ...
    public void ShouldFindRegQWordValues()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(t => t.ValueName == "LastWatsonCabUploaded");
    ...
    public void TestVkRecordFileTimeRegType()
    {
        ...
        if (key is not null)
        {
            val = key.Values.Single(e => e.ValueName == "en-US");
